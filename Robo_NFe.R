...
# OBSERVAÇÃO: O PRESENTE CÓDIGO APRESENTA REDUNDÂNCIAS QUE PODERÃO SER RESOLVIDAS COM A INSERÇÃO DE FUNÇÕES E OUTROS MECANISMOS, DE FORMA A REDUZIR O NÚMERO DE LINHAS. TAIS REDUNDÂNCIAS AFETAM A VELOCIDADE DO ROBÔ, PORÉM, NÃO AFETAM, A PRINCÍPIO, A SUA EFICÁCIA.
